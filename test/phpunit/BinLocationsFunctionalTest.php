...
/**
 * \file    test/phpunit/BinLocationsFunctionalTest.php
...
/**
 * Class BinLocationsFunctionalTest
 *
 ...
 *
 * @package Testbinlocations
 */
class BinLocationsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modBinLocations')->click();
		} else {
			// Disable the module
			$this->byHref('modBinLocations')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/binlocations/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('binlocations/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/binlocations/admin/about.php');
		$this->authenticate();
		return $this->assertContains('binlocations/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('binlocationswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modBinLocations_BinLocationsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modBinLocations_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
